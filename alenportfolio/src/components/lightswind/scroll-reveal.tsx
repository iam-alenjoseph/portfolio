...
export function ScrollReveal({
  ...
  // Only attach a scroll listener when rotation is actually needed.
  // All 4 sections in Index.tsx use baseRotation=0, so this avoids
  // 4 redundant scroll event subscribers firing on every frame.
  ...
  const rotation = useTransform(
    scrollYProgress,
    [0, 0.5, 1],
    baseRotation !== 0 ? [baseRotation, 0, 0] : [0, 0, 0]
  );
