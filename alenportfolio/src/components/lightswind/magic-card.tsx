...
export const MagicCard = ({
    ...
    return (
        <article
            ...
            className={cn(
                "group relative aspect-[4/3] w-[300px] cursor-pointer rounded-xl outline outline-2 outline-neutral-200 dark:outline-neutral-800 bg-neutral-50 dark:bg-neutral-900 transition-all duration-300 active:scale-[0.99] active:translate-y-px",
                className
            )}
            {...props}
        >
            ...
            <div className="absolute inset-0 grid place-items-center gap-2 overflow-hidden rounded-xl [clip-path:inset(0_round_12px)]">
                ...
                <div
                    ...
                    style={{
                        ...
                        translate: 'calc(var(--pointer-x, -10) * 35%) calc(var(--pointer-y, -10) * 35%)',
                        scale: '3.4',
